 ...
 * {@link Description.OnDescriptionInteractionListener} interface
...
public class Description extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            //mListener.OnDescriptionInteractionListener(uri);
        }
    }
    ...
    public void addText ()
    {
        ((TextView)getView().findViewById(R.id.description)).setText("This is chat room");
    }
